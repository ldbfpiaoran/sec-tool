...
#     testurl = "https://a.alipayobjects.com/g/h5platform-bj/charityngo/0.2.3/static/js/main.js"
#     print(testurl)
#     file = send_request(testurl)
#     endpoints = parser_file(file, regex_str, mode=0)
#     print(endpoints)